-- Add RLS Policies for Phase 6 Tables (Fixed - Drop existing first)
...
-- Drop panic_words policies
DROP POLICY IF EXISTS "users_manage_own_panic_words" ON panic_words;
DROP POLICY IF EXISTS "police_view_all_panic_words" ON panic_words;

-- Drop check_ins policies  
DROP POLICY IF EXISTS "users_view_own_check_ins" ON check_ins;
DROP POLICY IF EXISTS "users_create_own_check_ins" ON check_ins;
DROP POLICY IF EXISTS "parents_view_children_check_ins" ON check_ins;
DROP POLICY IF EXISTS "children_view_parents_check_ins" ON check_ins;
DROP POLICY IF EXISTS "police_view_all_check_ins" ON check_ins;

-- Drop family_links update policy
DROP POLICY IF EXISTS "users_update_family_consent" ON family_links;
